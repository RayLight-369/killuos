...
const Home = () => {
  return (
    <section>
      <div className='h-[600px] w-screen bg-[var(--hero-bg)] relative overflow-hidden flex flex-row items-center px-14'>
        <div className='text-white relative w-[40%] flex flex-col gap-6'>
          ...
          <button className='text-left w-[153px] px-8 py-2 bg-[var(--button-bg)] hover:shadow-md overflow-hidden transition-all duration-[250ms] hover:px-5 hover:-skew-y-3 hover:-skew-x-3 rounded-md relative after:transition-all after:duration-200 after:content-["→"] after:absolute after:text-[24px] after:-right-10 after:text-white after:block after:top-1/2 after:-translate-y-1/2 hover:after:right-5'>Get in touch</button>
        </div>
        <img className='absolute h-full top-0 right-10' src="/Imgs/illustration.svg" alt="illustration" />
      </div>
